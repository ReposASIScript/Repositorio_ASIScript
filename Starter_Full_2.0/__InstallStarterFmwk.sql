...
ACCEPT smtp_server_address CHAR DEFAULT 'smtp.&&mydomain' PROMPT "Enter the address of your SMTP server for DB-generated email (Default is smtp.+&&mydomain). If you don't have an SMTP server, enter None: "
ACCEPT ldap_server_address CHAR DEFAULT 'ldap.&&mydomain' PROMPT "Enter the address of your LDAP directory server for optional LDAP library (Default is ldap.+&&mydomain+:389). If you don't have an LDAP server, enter None: "
...
ACCEPT core_log_path CHAR DEFAULT '&core_dir_path+\logs' PROMPT "Enter the full path for DB log files (Default is &core_dir_path+\logs): "
ACCEPT core_mail_path CHAR DEFAULT '&core_dir_path+\mail' PROMPT "Enter the full path for email files written by the DB (Default is &core_dir_path+\mail: "
...
PROMPT Just for the purpose of completing a full pilot environment, three new
